...
This template deploys a cluster to the Azure Marketplace.  It is not intended to be used outside the marketplace. makeArchive.sh will build a zip file that can be uploaded to the publish portal.  This tempalte depends on the simple template.
